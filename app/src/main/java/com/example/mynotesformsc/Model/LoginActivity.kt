...
import com.example.mynotesformsc.Activity.MainActivity
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if(requestCode == AUTHUI_REQUEST_CODE){
            //we have sign-in user or nwe user
            ...
            if (response == null){
                Log.d(TAG,"onActivityResult: The user  Cancelled the sign in requset")
            }else{
